        ...
        <div className="flex flex-wrap justify-between gap-4">
          ...
          <div className="w-full sm:w-1/2 lg:w-1/4">
            ...
            <div className="flex space-x-3">
              <a
                href="https://www.facebook.com/immecchurch?locale=pt_BR"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white text-[#1414b8] w-8 h-8 flex items-center justify-center rounded-full hover:text-black transition"
              >
          ...
          <div className="w-full sm:w-1/2 lg:w-1/5">
            ...
            <ul className="space-y-1">
              <li>
                <a href="#historia" className="hover:text-black">
                  Nossa História
                </a>
              </li>
              <li>
                <a href="#celulas" className="hover:text-black">
                  Células
                </a>
              </li>
              <li>
                <a href="#ministerios" className="hover:text-black">
                  Ministérios
                </a>
              </li>
              <li>
                <a href="#eventos" className="hover:text-black">
                  Eventos
                </a>
              </li>
              <li>
          ...
          <div className="w-full sm:w-1/2 lg:w-1/4">
            ...
            <ul className="space-y-1">
              <li>
                <a
                  href="https://www.google.com/maps/place/Galeria+Via+Cabu%C3%A7%C3%BA/@-22.9167002,-43.5351794,17z/data=!3m1!4b1!4m6!3m5!1s0x9be1330dee859d:0xca75fdaad4eed82a!8m2!3d-22.9167002!4d-43.5351794!16s%2Fg%2F11g854r24t?entry=ttu&g_ep=EgoyMDI1MDgxMy4wIKXMDSoASAFQAw%3D%3D"
                  target="_blank"
              ...
              <li>
                <a
                  href="mailto:immecchurch@gmail.com"
                  className="flex items-center hover:text-black"
                >
                  <i className="fa fa-envelope mr-2" />
                  immecchurch@gmail.com
                </a>
              </li>
            ...
            <ul className="space-y-1">
              <li className="flex items-start">
                ...
                <span>
                  ...
                  CONTA: 13.005872-5
                  <br />
                  IGREJA METODISTA MINISTÉRIO EMBARCADOS COM CRISTO
                  <br />
