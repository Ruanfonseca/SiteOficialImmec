...
import ekballo from '@/app/assets/ekballo.jpeg';
import uber from '@/app/assets/uber.svg';
import Image from "next/image";
import { useState } from "react";


export default function Ekballo(){
                ...
                <section className="relative py-16 bg-white">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div className="space-y-4">
                            <h2 className="text-3xl font-bold">Célula Ekballo</h2>
                            ...
                            Liderada por Luan Antunes.
                            <br />
                            <br />
                            Anfitriões: Luan Antunes.
                            </p>
